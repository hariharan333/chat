...
client  = MongoClient("mongodb+srv://test:test@chatapp.diqig.mongodb.net/myFirstDatabase?retryWrites=true&w=majority")
...
def add_room_member(room_id,room_name,username,added_by,is_room_admin=False):
	room_members_collection.insert_one(
		{'id':{'room_id':ObjectId(room_id),'username':username},
